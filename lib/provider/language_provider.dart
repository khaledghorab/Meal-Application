...
class LanguageProvider with ChangeNotifier {
  ...
  Map<String, Object> textsAr = {
    ...
    "Gluten-free-sub": "يتضمن فقط الأطعمة الخالية من الكلوتين",
    "Lactose-free": "خالي من اللاكتوز",
    "Lactose-free_sub": "يتضمن فقط الأطعمة الخالية من مشتقات الحليب",
    "Vegetarian": "نباتي",
    "Vegetarian-sub": "يتضمن الأطعمة الخالية من المنتجات الحيوانية",
    "Vegan": "نباتي",
    "Vegan-sub": "يتضمن فقط الأطعمة الخالية من المنتجات الحيوانية ومشتقاتها",
    ...
    "Affordability.Luxurious": "باهظة الثمن",
    "min": "دقيقة",
    "min2": "دقائق",
    ...
    "Steps": "الخطوات",
    "favorites_text":
        "لم تقم بإضافة طعام مفضل لحد الآن - قم بأضافة بعض الأطعمة!",
    "ingredients-m1": [
      "4 طماطم",
